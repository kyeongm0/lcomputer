...
public class JwtUtils {
	private static final String jwtSecret = "lcomputerexample";
	...
	private static Claims getClaimsFormToken(String token) {
		return (Claims) Jwts.parser().setSigningKey(DatatypeConverter.parseBase64Binary(jwtSecret)).parseClaimsJws(token).getBody();
	}
